...
func (s semiOnlineOrderUnshippedPackageService) Query(ctx context.Context, params SemiPlatformLogisticsUnshippedPackageQueryParams) (items []entity.SemiPlatformLogisticsUnshippedPackage, total, totalPages int, isLastPage bool, err error) {
	params.TidyPager()
