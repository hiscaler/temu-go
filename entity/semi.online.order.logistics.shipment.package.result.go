...
type SemiOnlineOrderLogisticsShipmentPackageResult struct {
	...
	FailReasonText      string   `json:"failReasonText"`      // 下单失败的原因 当命中周六不可派送场景时，下单失败原因提示如下 “Saturday Delivery is unavailable to desired destination.”
	...
	SolutionText   string   `json:"solutionText"`   // 失败原因对应的解决方案
