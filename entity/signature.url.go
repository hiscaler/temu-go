...
// - 将 toa-access-token 和 toa-app-key 和 toa-random 和 toa-timestamp 4 个参数进行首字母以 ASCII 方式升序排列 ascii asc，
// 对于相同字母则使用下个字母做二次排序，字母序为从左到右，以此类推
